...
__device__ __host__ void generateContingencyTable2Way(uint32_t *dest, uint32_t *numcases, uint32_t *numctrls, const unsigned char* db, unsigned snpsize, unsigned casecount, unsigned a, unsigned b);
__device__ __host__ void generateContingencyTable3Way(uint32_t *dest, uint32_t *numcases, uint32_t *numctrls, const unsigned char* db, unsigned snpsize, unsigned casecount, unsigned a, unsigned b, unsigned c);
